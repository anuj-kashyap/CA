  ...
  const features = [
    {
      imageSrc: vis,
      title: "Our Vision",
      description: "Our firm continuously strives to be the Premier Accounting Firm, providing the highest level of excellent service to our clients and an excellent quality of life for our associates."
    },
    {
      imageSrc: targ,
      title: "Our Mission",
